  ...
  OLLAMA_SETUP_TRACK,
  {
    ...
    steps: [
      ...
      },
      {
          ...
          <>
            ...
            <AboutList
              items={[
                ...
                <>
                  Start / Stop Ollama and Chatterbox, unload models, and see GPU/CPU load in{' '}
                  <strong>Hardpoint</strong>. RolePlaymate no longer starts those services on
                  launch.
                </>,
              ]}
            />
        ...
        pageLink: { to: '/hardpoint', label: 'Hardpoint' },
      },
      {
        kicker: 'Optional',
